    ...
    <div className="side-bar">
      <div className="profile">
        <div className="profile-pic">
          <img
            src="https://pbs.twimg.com/profile_images/1378571837542707204/wyKCDtGA_400x400.jpg"
            alt="username-pic"
          />
        </div>
        <div className="profile-description">
          <div className="profile-fullname">
            <label>Shizuka Minamoto</label>
          </div>
          <div className="profile-username">
            <label>@shizuka_123</label>
          </div>
        </div>
      </div>
      ...
      <ul>
        <li onClick={() => handleClick("Booking")}>
          ...
          <div className="li-label">Booking Buddy</div>
        </li>
        <li onClick={() => handleClick("Upcoming")}>
          ...
          <div className="li-label">Upcoming Bookings</div>
        </li>
        <li>
          <div className="li-icon">
            <svg
        ...
        <li onClick={()=>{handleClick("Explore")}}>
          ...
          <div className="li-label">Explore</div>
        </li>
        <li>
          <div className="li-icon">
            <svg
          ...
          <div className="li-label">Settings</div>
        </li>
        <li>
          <div className="li-icon">
            <svg
          ...
          <div className="li-label">Language</div>
        </li>
      </ul>
      <div className="horizontal-line"></div>
